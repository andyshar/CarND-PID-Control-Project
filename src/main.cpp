...
int main()
{
  ...
  double init_pid_kp = 0.11;
  double init_pid_ki = 0.0001;
  double init_pid_kd = 2.0;
  pid.Init(init_pid_kp, init_pid_ki, init_pid_kd);
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // DEBUG
          std::cout << "CTE: " << cte << " Steering Value: " << steer_value << " Angle Value: " << angle << std::endl;
